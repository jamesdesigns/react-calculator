...
const Results = (props) => {
	...
	return (
		<ul style={{ backgroundColor: '#181818', padding: '30px 30px 15px 26px', borderTopLeftRadius: '15px', borderTopRightRadius: '15px', marginTop: '1px', marginTop: '10px'}} className="results flex-row">
